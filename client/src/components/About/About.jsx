...
const About = () => {
  ...
  return (
    <section className="py-6 sm:py-10 md:py-12 relative" id="about">
      <div className="max-w-[1480px] mx-auto px-4 sm:px-8 md:px-10 lg:px-12 w-full">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col gap-4 sm:gap-6 max-w-4xl">
            {/* Tag / Eyebrow */}
            ...
            {/* Content */}
            <div className="flex flex-col gap-3 sm:gap-4 text-xs sm:text-base text-gray-300 leading-relaxed font-normal">
              <p>
